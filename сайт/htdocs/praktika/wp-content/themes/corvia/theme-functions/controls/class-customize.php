	...
	public function sections( $manager ) {
		...
		$manager->add_section(
			new Corpiva_Customize_Section_Pro(
				...
				'corpiva',
				array(
                    'pro_text' => esc_html__( 'Upgrade to Corvia Pro','corvia' ),
                    'pro_url'  => 'https://desertthemes.com/themes/corvia-pro/',
                    'priority' => 0
                )
			)
		);
